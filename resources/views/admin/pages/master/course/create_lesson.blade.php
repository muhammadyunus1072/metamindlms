...
@section('content')
    ...
    <?php 
        ...
        $list_route = array(
            "back" => $data["croute"] . 'edit_section/' . enc($results_data->id),
        );
    ?>
    ...
    <div class="page__container page-section">
        ...
        <form action="{{ $data['croute'] . 'store_lesson/' . enc($results_data->id) }}" id="form-data" method="POST" enctype="multipart/form-data">
        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="custom-control custom-checkbox">
                                        <input id="can_preview" name="can_preview" type="checkbox" class="custom-control-input" value="1">
