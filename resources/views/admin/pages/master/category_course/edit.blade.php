...
@section('content')
    ...
    <?php 
        $list_route = array(
            "search_group_category" => $data["croute"] . "search_group_category",
        );
    ?>
            ...
            @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-6">
                                <label class="form-label" for="description">Grup Kursus :</label>
                                <select name="group_category_course_id" id="group_category_course_id" class="form-control custom-select select2">
                                    <option value="{{ enc($results_data->group_category_course_id) }}" selected>{{ $results_data->group_category_name }}</option>
                                </select>
                            </div>
...
<script>
    $("#form-data").submit(function(e) {
		...
		file_data.append('group_category_course_id', $('#group_category_course_id').val());
