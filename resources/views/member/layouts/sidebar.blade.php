...
<ul class="sidebar-menu">
    ...
    <li class="sidebar-menu-item {{ Request::segment(2) == 'e_commerce' ? 'active' : '' }}">
        <a class="sidebar-menu-button" href="{{ route('member.e_commerce.index') }}">
            <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">star</span>
            <span class="sidebar-menu-text">Produk / Paket</span>
        </a>
    </li>
    ...
    @if (Auth::check())
        ...
        <li class="sidebar-menu-item {{ Request::segment(2) == 'transaction' ? 'active' : '' }}">
