...
<html lang="en"
    ...
    <body class="layout-default layout-login-image">
        ...
        <div class="layout-login-image__overlay"
             style="background-image: url({{ asset('/assets/images/1280_15ntkpxqt54y-sai-kiran-anagani.jpg') }});">
            <div class="fullbleed bg-dark"
                 style="opacity: .5"></div>
        </div>

        <div class="layout-login-image__form bg-white vh-100"
            ...
            <form action="{{ route('login.do_login') }}" id="login-form" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input id="email" name="email" type="email" class="form-control form-control-prepended" placeholder="Email">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input id="password" name="password" type="password" class="form-control form-control-prepended" placeholder="Password">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
