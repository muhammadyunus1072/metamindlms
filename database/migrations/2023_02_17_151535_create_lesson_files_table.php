...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('_history_lesson_files', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('_history_lesson_files');
    }
    ...
    private function scheme(Blueprint $table, $is_history = false)
    {
        ...
        $table->string('extension')->nullable()->comment('Ext Files');
