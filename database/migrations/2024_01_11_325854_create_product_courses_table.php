...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('_history_product_courses', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('_history_product_courses');
    }
    ...
    private function scheme(Blueprint $table, $is_history = false)
    {
        ...
        if ($is_history) {
            ...
            $table->index('product_id', 'product_courses_product_id_index');
