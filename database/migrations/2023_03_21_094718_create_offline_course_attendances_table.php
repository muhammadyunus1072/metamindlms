...
return new class extends Migration
{
    public function up()
    {
        Schema::create('offline_course_attendances', function (Blueprint $table) {
            $this->scheme($table);
        });

        Schema::create('_history_offline_course_attendances', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('offline_course_attendances');
        Schema::dropIfExists('_history_offline_course_attendances');
    }
