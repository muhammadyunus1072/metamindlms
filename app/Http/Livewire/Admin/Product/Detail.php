...
class Detail extends Component
{
    ...
    {
        $this->emit('consoleLog', $this->removed_course_olds);
        $this->emit('consoleLog', $this->removed_offline_course_olds);
        // Validation Steps
        $this->validate();
        $validatedData = [
            'name' => $this->name,
        ...
        session()->flash('success', 'Produk Berhasil ' . ($this->product_id == null ? 'Ditambahkan' : 'Diperbarui'));
