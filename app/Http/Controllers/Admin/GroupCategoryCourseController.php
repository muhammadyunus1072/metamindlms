...
class GroupCategoryCourseController extends Controller
{
    private $ctitle = "Grup Kategori";
    private $view_path = "admin.pages.master.group_category_course.";
    private $routes_path;
    private $has_access = "group_category_course";

    public function __construct()
    {
        $this->routes_path = route('admin.group_category_course.index') . "/";
    }
                ...
                ->filter(function ($query) use ($request){
                    if ($request->search['value']) {
                        ...
                        $query->where(function ($query) use ($search_value) {
                            $query->where('group_category_courses.code', 'like', $search_value)
                                ->orWhere('group_category_courses.name', 'like', $search_value)
    ...
    public function store(Request $request)
    {
        ...
        if(request()->ajax()){
            try {
                ...
                $results_data = new GroupCategoryCourse();
    ...
    public function edit($id, Request $request)
    {
        ...
        $results_data = GroupCategoryCourse::find($id);
